...
@section('content')
<div class="container-xl px-4" style="max-width: 1000px;">

    {{-- Encabezado --}}
    <div class="mb-4">
        <h2 class="fw-bold" style="color: #00324D;">Área</h2>
        <p class="text-secondary small mb-0">Gestión y registro de áreas de formación</p>
    </div>
    ...
    <div class="form-sena-card overflow-hidden mb-5">
        <div class="px-4 py-3 border-bottom">
            <h5 class="fw-bold mb-0" style="color: #00324D;">Áreas registradas</h5>
        </div>
        <div class="p-0">
            @if($areas->isEmpty())
                    ...
                    <table class="table table-hover table-sena align-middle mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="py-3 text-end px-4" style="width: 280px;">Acciones</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($areas as $area)
                                <tr>
                                    ...
                                    <td class="fw-semibold" style="color: #00324D;">
                                        <i class="bi bi-journal-bookmark me-2 fs-5 align-middle" style="color: #39A900;"></i>
                                        <span>{{ $area->name }}</span>
                                    </td>
                                    <td class="text-end px-4">
                                        <div class="d-inline-flex align-items-center gap-2">
                                            <a href="{{ route('area.show', $area->id) }}" class="btn btn-sm btn-outline-primary btn-sena-outline d-inline-flex align-items-center gap-1">
                                                <i class="bi bi-eye"></i> Mostrar
                                            </a>
                                            <a href="{{ route('area.edit', $area->id) }}" class="btn btn-sm btn-outline-success btn-sena-outline d-inline-flex align-items-center gap-1">
    ...
    {{-- Formulario Crear Nueva Área --}}
    <div class="form-sena-card p-4 p-md-5">
        <h5 class="fw-bold mb-4" style="color: #00324D;">Crear nueva área</h5>
        ...
        <form action="{{ route('area.store') }}" method="POST">
            ...
            <div class="row g-3" style="max-width: 500px;">
                <div class="col-12">
                    <label for="name" class="form-label small fw-bold text-secondary">Nombre del Área</label>
                    <input type="text"
                           name="name"
                           id="name"
